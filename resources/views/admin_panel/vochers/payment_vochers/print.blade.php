...
<body>
    ...
    <div class="print-controls no-print">
        ...
        <a href="{{ route('all_Payment_vochers') }}" class="btn btn-secondary">← Back</a>
    </div>
    ...
    <div class="receipt-container">
        ...
        <!-- Meta Info -->
        <div class="meta-info">
            <span><strong>Voucher No:</strong> {{ $voucher->pvid }}</span>
        ...
        @if ($party)
            @if(in_array($voucher->type, ['customer', 'walkin']))
                <div class="meta-info-block">
                    <strong>Paid To:</strong> {{ $party->customer_name ?? $party->name ?? '-' }}
                </div>
            ...
            @elseif($voucher->type === 'vendor')
                <div class="meta-info-block">
                    <strong>Paid To:</strong> {{ $party->name ?? '-' }}
                </div>
        ...
        <table class="items-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 60%;">Account (Paid From)</th>
